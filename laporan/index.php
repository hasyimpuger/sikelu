                        ...
                        <div class="block">
                            ...
                            <form action="index.php" method="post" class="form-horizontal form-bordered">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select name="kk" id="example-chosen" class="select-chosen">
                                            <option value="">--Pilih KK (Biarkan Kosong untuk Memilih Semua)--</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select name="rt" id="example-chosen" class="select-chosen">
                                            <option value="">--Pilih RT (Biarkan Kosong untuk Memilih Semua)--</option>
                                            <?php for ($i=1; $i < 28; $i++) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select name="klasifikasi" id="example-chosen" class="select-chosen">
                                            <option value="">--Pilih Klasifikasi (Biarkan Kosong untuk Memilih Semua)--</option>
