                ...
                <div id="main-container">
                    ...
                    <div id="page-content">
                                ...
                                <div class="col-sm-6 hidden-xs">
                                    <div class="header-section">
                                        <ul class="breadcrumb breadcrumb-top">
                                            <li><a href="../dashboard">SIKLELU</a></li>
                                            <li><a href="../pilihan.php?menu=3">RT</a></li>
                                            <li>EDIT</li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="block">
                            ...
                            <form action="edit.php?id<?php echo $edit['id_rt']; ?>" method="post" class="form-horizontal form-bordered">
                                <div class="form-group">
                                    <input type="hidden" name="id_rt" value="<?php echo $edit['id_rt']; ?>">
                                    <label class="col-md-3">RT</label>
                                    <div class="col-md-8">
                                        <input type="text" name="nama_rt" class="form-control" placeholder="RT" value="<?php echo $edit['nama_rt'] ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3">RW</label>
                                    <div class="col-md-8">
                                        <input type="text" name="nama_rw" class="form-control" placeholder="RW" value="<?php echo $edit['nama_rw'] ?>">
                                    </div>
                                </div>
