...
$profil = "../profil.php";
$title = "DETAIL RT ".$_GET['detail']." || SIKELU";
 ?>
                    ...
                    <div id="page-content">
                                ...
                                <div class="col-sm-6 hidden-xs">
                                    <div class="header-section">
                                        <ul class="breadcrumb breadcrumb-top">
                                            ...
                                            <li>DETAIL RT <?php echo $_GET['detail'] ?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="block full">
                            <div class="block-title">
                                <h2><i class="fa fa-cubes sidebar-nav-icon"></i> DETAIL RT <?php echo $_GET['detail'] ?></h2>
                            </div>
                                    ...
                                    <?php $no=0; foreach ($kk as $row): $no++?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="../kk/detail.php?detail=<?php echo $row['no_kk']; ?>" data-toggle="tooltip" title="Detail <?php echo $row['no_kk']?>" class="btn btn-effect-ripple btn-warning"><i class="fa fa-search"></i></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../kk/index.php" method="post" class="form-bordered">
                            ...
                            <div class="form-group">
                                <label>RT</label>
                                <input type="text" name="rt" class="form-control" value="<?php echo $_GET['detail'] ?>" required readonly>
                            </div>
                            <div class="form-group">
                                <label>RW</label>
                                <input type="text" name="rw" class="form-control" value="<?php echo $_GET['rw'] ?>" required readonly>
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
