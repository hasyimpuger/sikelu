...
class Penduduk
{
    ...
    public function tambah_anggota(){
        ...
        $tambah = $_mysqli->query("INSERT INTO penduduk (nik, nama, tempat_lahir, tanggal_lahir, jk, golongan_darah, alamat, desa, kecamatan, pekerjaan, pendidikan, status_perkawinan, kewarganegaraan, id_agama, id_klasifikasi, no_kk, foto, status) 
            VALUES ('$nik', '$nama', '$tempat_lahir', '$tanggal_lahir', '$jk', '$golongan_darah', '$alamat', '$desa', '$kecamatan', '$pekerjaan', '$pendidikan', '$status_perkawinan', '$kewarganegaraan', '$id_agama', '$id_klasifikasi', '$no_kk', '$fotoup', 0)");
        if ($tambah) {
