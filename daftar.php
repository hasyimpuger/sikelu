            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Web ini adalah sarana komunikasi dan pusat data Penduduk Kelurahan Sumbang</p>
                        <h4 class="page-header">2. <strong>Akun</strong></h4>
                        <p>Penduduk yang bisa mendaftar dan login adalah Peduduk Kelurahan Sumbang</p>
                    </div>
